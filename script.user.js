...
// @version             1.0.0
// @description         The script is a web scraper for Instagram web, where you can find out who doesn't follow you back and who you don't follow back. You can also check the last analysis performed.
// @description:pt-BR   O script é um web scraper para o Instagram web, onde permite descobrir quem não segue você de volta e quem você não segue de volta. Também, é possível conferir a última analise realizada.
// @author              cjambrosi
// @license             MIT
